...
const DueDiligenceDetail: React.FC<DueDiligenceDetailProps> = ({ item }) => {
  return (
    <Descriptions column={2}>
      ...
      <Descriptions.Item label="供应商行业">
        {item.supplierIndustry}
      </Descriptions.Item>
      <Descriptions.Item label="供应商地址">
        {item.supplierAddress}
      </Descriptions.Item>
      <Descriptions.Item label="租赁金额">
        {item.leaseAmount}
      </Descriptions.Item>
